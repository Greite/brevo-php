...
class TransactionalSMSApi
{
    ...
    protected function getSmsEventsRequest($limit = '50', $startDate = null, $endDate = null, $offset = '0', $days = null, $phoneNumber = null, $event = null, $tags = null, $sort = 'desc')
    {
        ...
        // query params
        if ($days !== null) {
            $queryParams['days'] = ObjectSerializer::toQueryValue($days, 'int64');
        }
        // query params
        if ($phoneNumber !== null) {
            $queryParams['phoneNumber'] = ObjectSerializer::toQueryValue($phoneNumber, null);
        }
        // query params
        if ($event !== null) {
    ...
    /**
     * Operation sendAsyncTransactionalSms
     *
     ...
     * @return void
     */
    public function sendAsyncTransactionalSms()
    {
        $this->sendAsyncTransactionalSmsWithHttpInfo();
    }

    /**
     * Operation sendAsyncTransactionalSmsWithHttpInfo
     *
     * Send SMS message asynchronously to a mobile number
     *
     *
     ...
     */
    public function sendAsyncTransactionalSmsWithHttpInfo()
    {
        $returnType = '';
        $request = $this->sendAsyncTransactionalSmsRequest();
    ...
    /**
     * Operation sendAsyncTransactionalSmsAsync
     *
     * Send SMS message asynchronously to a mobile number
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendAsyncTransactionalSmsAsync()
    {
        return $this->sendAsyncTransactionalSmsAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation sendAsyncTransactionalSmsAsyncWithHttpInfo
     *
     * Send SMS message asynchronously to a mobile number
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendAsyncTransactionalSmsAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->sendAsyncTransactionalSmsRequest();
    ...
    /**
     * Create request for operation 'sendAsyncTransactionalSms'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sendAsyncTransactionalSmsRequest()
    {

        $resourcePath = '/transactionalSMS/send';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \Brevo\Client\Model\SendTransacSms $body Values to send a transactional SMS (required)
     *
     * @throws \Brevo\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Brevo\Client\Model\SendSms
     */
    public function sendTransacSms($body)
    {
        list($response) = $this->sendTransacSmsWithHttpInfo($body);
        return $response;
    }
     ...
     */
    public function sendTransacSmsWithHttpInfo($body)
    {
        $returnType = '\Brevo\Client\Model\SendSms';
        $request = $this->sendTransacSmsRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendTransacSmsAsync($body)
    {
        return $this->sendTransacSmsAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendTransacSmsAsyncWithHttpInfo($body)
    {
        $returnType = '\Brevo\Client\Model\SendSms';
        $request = $this->sendTransacSmsRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sendTransacSmsRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling sendTransacSms'
            );
        }
