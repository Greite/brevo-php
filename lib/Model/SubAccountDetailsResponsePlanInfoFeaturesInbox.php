...
class SubAccountDetailsResponsePlanInfoFeaturesInbox implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'subAccountDetailsResponse_planInfo_features_inbox';
